...
<body class="gray-bg">
											                        ...
											                        <form class="form-horizontal m-t">
											                            ...
											                            <div class="form-group draggable">
											                                <label class="col-sm-3 control-label no-padding-right" for="form-field-1">下拉框：</label>
																				...
																				<div class="selQ719887135Qsel"></div>
											                            ...
											                            <div class="form-group draggable">
																			...
																			<div class="col-sm-9">
																				<div class="fileQ719887135Qfile"></div>
	...
	function getUeditorFormHtml(html,msg,isgx){
		var arryUe = html.split('<div class="ueQ719887135Que"></div>');
		if(arryUe.length == 3){
			var uejscode = "<script id=\"editor\" type=\"text/plain\" style=\"width:96%;height:200px;\"><\/script>";
			if(msg == '1'){
				if(isgx == '2'){
					ueditorHtml = arryUe[1];
					return arryUe[0] + '<div class="ueQ719887135Que"></div>' + uejscode + '<div class="ueQ719887135Que"></div>' + arryUe[2];
				}else{
					return arryUe[0] + '<div class="ueQ719887135Que"></div>' + ueditorHtml + '<div class="ueQ719887135Que"></div>' + arryUe[2];
				}
			}else{
	...
	function getSelectFormHtml(html,msg,isgx){
		var arrySe = html.split('<div class="selQ719887135Qsel"></div>');
		if(arrySe.length == 3){
			...
			if(msg == '1'){
				if(isgx == '2'){
					return arrySe[0] + '<div class="selQ719887135Qsel"></div>' + selectcode + '<div class="selQ719887135Qsel"></div>' + arrySe[2];
				}else{
					selectHtml = arrySe[1];
					return html;
				}
	...
	function getFileFormHtml(html,msg,isgx){
		var arryFile = html.split('<div class="fileQ719887135Qfile"></div>');
		if(arryFile.length == 3){
			var filecode = "<input type=\"file\" id=\"tp\" name=\"tp\" />";
			if(msg == '1'){
				if(isgx == '2'){
					fileHtml = arryFile[1];
					return arryFile[0] + '<div class="fileQ719887135Qfile"></div>' + filecode + '<div class="fileQ719887135Qfile"></div>' + arryFile[2];
				}else{
					return arryFile[0] + '<div class="fileQ719887135Qfile"></div>' + fileHtml + '<div class="fileQ719887135Qfile"></div>' + arryFile[2];
				};
			}else{
