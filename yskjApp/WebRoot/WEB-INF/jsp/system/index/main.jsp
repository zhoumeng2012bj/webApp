				...
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<div class="ace-settings-container" id="ace-settings-container">
							<div class="btn btn-app btn-xs btn-warning ace-settings-btn" id="ace-settings-btn" style="height:33px;">
								 <i class="ace-icon fa fa-cog bigger-10" style="line-height: 22px;"></i>
							</div>
