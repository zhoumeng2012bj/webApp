...
<body>
		...
		<div id="loginbox" >
			<form action="" method="post" name="loginForm" id="loginForm">
				<div class="control-group normal_text">
					<h3>
						<img src="static/login/logo23.png" alt="Logo"   height="200" width="200"/>
					</h3>
				</div>
			...
			<div class="controls">
				<div class="main_input_box">
					<font color="white"><span id="nameerr">Copyright © ZXLqq719887135 2017</span></font>
				</div>
			</div>
		</div>
		</div>
	...
	<div id="templatemo_banner_slide" class="container_wapper">
		<div class="camera_wrap camera_emboss" id="camera_slide">
			<div data-src="static/login/bj.jpg"></div>
		</div>
	</div>
	...
	<script type="text/javascript">
		...
		function severCheck(){
			if(check()){
				...
				var code = "qq719887135fh"+loginname+",fh,"+password+"QQ976351811fh"+",fh,"+$("#code").val();
				$.ajax({
					type: "POST",
					url: 'login_login',
