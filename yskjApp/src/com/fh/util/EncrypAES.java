...
已经被多方分析且广为全世界所使用。经过五年的甄选流程，高级加密标准由美国国家标准与技术研究院（NIST）
于2001年11月26日发布于FIPS PUB 197，并在2002年5月26日成为有效的标准。2006年，
...
public class EncrypAES {  
 ...
 // 加密  
    ...
    public static void main(String args[]){  
        String ss="15093648677"; 
        System.out.println("加密后："+getBase64(ss));  
        System.out.println("解密后："+getFromBase64(getBase64(ss)));  
    }  
