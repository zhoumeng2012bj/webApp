...
public class ChatServer extends WebSocketServer{
	...
	public void onMessage(WebSocket conn, String message){
		...
		if(null != message && message.startsWith("FHadminqq719887135")){
			this.userjoin(message.replaceFirst("FHadminqq719887135", ""),conn);
		}if(null != message && message.startsWith("LeaveFHadminqq719887135")){
			this.userLeave(conn);
